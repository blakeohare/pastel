...
namespace Pastel
{
    internal class ProjectConfig
    {
        public ProjectConfig()
        {
            ...
            this.DependenciesByPrefix_DELETE = new Dictionary<string, ProjectConfig>();
            ...
            this.PhpFileIncludes_DELETE = new List<string>();
            this.PhpFileIncludeIsOptional_DELETE = new HashSet<string>();

            // public helper functions related to interop with Pastel code. This is true by default.
            // However, if your final codebase includes multiple components generated by Pastel, these will
            // be duplicates.
            this.IncludePublicPastelUtil_DELETE = true;
        }
        ...
        public Dictionary<string, ProjectConfig> DependenciesByPrefix_DELETE { get; set; }
        public string OutputDirStructs { get; set; }
        public string OutputFileFunctions { get; set; }
        public string OutputFileFunctionsSuffix_DELETE { get; set; }
        ...
        public bool IncludePublicPastelUtil_DELETE { get; set; }
        public List<string> PhpFileIncludes_DELETE { get; set; }
        public HashSet<string> PhpFileIncludeIsOptional_DELETE { get; set; }
