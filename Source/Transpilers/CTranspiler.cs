...
namespace Pastel.Transpilers
{
    internal class CTranspiler : CurlyBraceTranspiler
    {
        ...
        {
            sb.Append("TranslationHelper_base64ToBytes(");
        ...
        {
            sb.Append("String_last_index_of(");
            this.TranslateExpression(sb, haystack);
            sb.Append(", ");
            this.TranslateExpression(sb, needle);
            sb.Append(')');
        ...
        {
            sb.Append("TranslationHelper_utf8_bytes_to_string(");
        ...
        public override void GenerateCodeForFunctionDeclaration(TranspilerContext sb, FunctionDefinition funcDef, bool isStatic)
        {
            sb.Append(this.TranslateType(funcDef.ReturnType));
            sb.Append(' ');
            sb.Append(funcDef.NameToken.Value);
